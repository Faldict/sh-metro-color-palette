...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#ea0437', '#87d300', '#ffd100', '#4f1f91', '#a24cc8', '#d71671', '#ff7200', '#009edb', '#78c7eb', '#bc87e6', '#7c2230', '#007b63', '#f293d1', '#7f7800', '#bba786', '#32d4cb']"
...
gset string palette "#ea0437:#87d300:#ffd100:#4f1f91:#a24cc8:#d71671:#ff7200:#009edb:#78c7eb:#bc87e6:#7c2230:#007b63:#f293d1:#7f7800:#bba786:#32d4cb"
